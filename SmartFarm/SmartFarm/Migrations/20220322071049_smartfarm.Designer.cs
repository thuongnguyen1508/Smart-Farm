...
namespace SmartFarm.Migrations
{
    ...
    [Migration("20220322071049_smartfarm")]
    partial class smartfarm
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartFarm.Data.Entities.InputData", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.Property<float>("ThongSo")
                        .HasColumnType("real");

                    b.HasKey("Id", "ThoiGianThem", "Unit");
            ...
            modelBuilder.Entity("SmartFarm.Data.Entities.OutputData", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id", "ThoiGianThem", "CustomerId");

                    b.HasIndex("CustomerId");

                    b.ToTable("OUTPUTDATA");
                });
            ...
            modelBuilder.Entity("SmartFarm.Data.Entities.InputData", b =>
                {
                    b.HasOne("SmartFarm.Data.Entities.Input", "Input")
                        .WithOne("InputData")
                        .HasForeignKey("SmartFarm.Data.Entities.InputData", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SmartFarm.Data.Entities.OutputData", b =>
                {
                    b.HasOne("SmartFarm.Data.Entities.Customer", "Customer")
                        .WithMany("OutputDatas")
